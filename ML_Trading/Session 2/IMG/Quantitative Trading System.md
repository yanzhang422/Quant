...
* Some Grahpical interpretations
  **CAPM Model**
![CAPM](https://github.com/yanzhang81/Quant/raw/master/SCL-plot.png)
...
In case we have three stocks in the portfolio, at time t, the return of portfolio is $r_p(t)$, at right side, expand the $P_i(t)$ in CAPM model, then we add the weight value $W_i$ into CAPM model, get CAPM portfolio model. Then we transfer $W_i\beta_i$ to be $\beta_p$, the beta of a portfolio is the weighted average of the assets that make up the portfolio, there is linear relationship between the portfolio and the market.
  ...
  **CAPM Portfolio Model**
![CAPM Portfolio](https://github.com/yanzhang81/Quant/raw/master/CAPM%20Portfolio%20Model.gif)
...
![Linearline](https://github.com/yanzhang81/Quant/raw/master/Linear%20regressions%20of%20Sales%20vs.%20TV%2C%20Radio%2C%20Newspaper.png)
...
Here is an example:
![regression function](https://github.com/yanzhang81/Quant/raw/master/Regression%20function.PNG)
...
![KNN neighbor](https://github.com/yanzhang81/Quant/raw/master/KNN%20neighborhood.PNG)
...
![Linear Activation](https://github.com/yanzhang81/Quant/raw/master/linear.png)
